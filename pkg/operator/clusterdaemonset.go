...
import (
	...
	"fmt"
	"kubesphere.io/fluentbit-operator/api/clusterfluentbitoperator/v1alpha2"
...
func MakeClusterRBACObjects(fbName, fbNamespace string) (*rbacv1.ClusterRole, *corev1.ServiceAccount, *rbacv1.ClusterRoleBinding) {
...
func MakeClusterScopedRBACObjects(fbName, fbNamespace string) (*rbacv1.Role, *corev1.ServiceAccount, *rbacv1.RoleBinding) {
	r := rbacv1.Role{
		ObjectMeta: metav1.ObjectMeta{
			Name:      "kubesphere:fluent-bit",
			Namespace: fbNamespace,
...
func MakeClusterDaemonSet(fb v1alpha2.ClusterFluentBit, logPath string) appsv1.DaemonSet {
	ds := appsv1.DaemonSet{
		ObjectMeta: metav1.ObjectMeta{
			Name:      fb.Name,
