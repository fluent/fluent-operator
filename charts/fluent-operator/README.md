...
![Version: 4.0.0-rc1](https://img.shields.io/badge/Version-4.0.0--rc1-informational?style=flat-square) ![AppVersion: 3.5.0](https://img.shields.io/badge/AppVersion-3.5.0-informational?style=flat-square)
...
|------------|------|---------|
|  | fluentd-crds | 0.1.0 |
| https://fluent.github.io/helm-charts | fluent-bit-crds | 0.1.0 |
...
| fluentbit.image.tag | string | `"4.2.0"` |  |
