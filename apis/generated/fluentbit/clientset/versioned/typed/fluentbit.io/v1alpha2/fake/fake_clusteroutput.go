...
var clusteroutputsResource = schema.GroupVersionResource{Group: "fluentbit.io", Version: "v1alpha2", Resource: "clusteroutputs"}

var clusteroutputsKind = schema.GroupVersionKind{Group: "fluentbit.io", Version: "v1alpha2", Kind: "ClusterOutput"}
...
func (c *FakeClusterOutputs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.ClusterOutput, err error) {
	...
	return obj.(*v1alpha2.ClusterOutput), err
}
...
func (c *FakeClusterOutputs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.ClusterOutputList, err error) {
	...
	list := &v1alpha2.ClusterOutputList{ListMeta: obj.(*v1alpha2.ClusterOutputList).ListMeta}
	for _, item := range obj.(*v1alpha2.ClusterOutputList).Items {
