...
func newOutputs(c *FluentdV1alpha1Client, namespace string) *outputs {
	return &outputs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *outputs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Output, err error) {
...
func (c *outputs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OutputList, err error) {
...
func (c *outputs) Create(ctx context.Context, output *v1alpha1.Output, opts v1.CreateOptions) (result *v1alpha1.Output, err error) {
	result = &v1alpha1.Output{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("outputs").
...
func (c *outputs) Update(ctx context.Context, output *v1alpha1.Output, opts v1.UpdateOptions) (result *v1alpha1.Output, err error) {
	result = &v1alpha1.Output{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("outputs").
...
func (c *outputs) UpdateStatus(ctx context.Context, output *v1alpha1.Output, opts v1.UpdateOptions) (result *v1alpha1.Output, err error) {
	result = &v1alpha1.Output{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("outputs").
...
func (c *outputs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Output, err error) {
	result = &v1alpha1.Output{}
