...
var fluentdconfigsResource = v1alpha1.SchemeGroupVersion.WithResource("fluentdconfigs")

var fluentdconfigsKind = v1alpha1.SchemeGroupVersion.WithKind("FluentdConfig")
