...
var inputsResource = schema.GroupVersionResource{Group: "fluentd.fluent.io", Version: "v1alpha1", Resource: "inputs"}

var inputsKind = schema.GroupVersionKind{Group: "fluentd.fluent.io", Version: "v1alpha1", Kind: "Input"}
...
func (c *FakeInputs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Input, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(inputsResource, c.ns, name), &v1alpha1.Input{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Input), err
}
...
func (c *FakeInputs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.InputList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(inputsResource, inputsKind, c.ns, opts), &v1alpha1.InputList{})
	...
	list := &v1alpha1.InputList{ListMeta: obj.(*v1alpha1.InputList).ListMeta}
	for _, item := range obj.(*v1alpha1.InputList).Items {
...
func (c *FakeInputs) Create(ctx context.Context, input *v1alpha1.Input, opts v1.CreateOptions) (result *v1alpha1.Input, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(inputsResource, c.ns, input), &v1alpha1.Input{})
...
func (c *FakeInputs) Update(ctx context.Context, input *v1alpha1.Input, opts v1.UpdateOptions) (result *v1alpha1.Input, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(inputsResource, c.ns, input), &v1alpha1.Input{})
...
func (c *FakeInputs) UpdateStatus(ctx context.Context, input *v1alpha1.Input, opts v1.UpdateOptions) (*v1alpha1.Input, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(inputsResource, "status", c.ns, input), &v1alpha1.Input{})
...
func (c *FakeInputs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(inputsResource, c.ns, name, opts), &v1alpha1.Input{})
...
func (c *FakeInputs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.InputList{})
	return err
}
...
func (c *FakeInputs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Input, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(inputsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Input{})
