...
var clusteroutputsResource = v1alpha1.SchemeGroupVersion.WithResource("clusteroutputs")

var clusteroutputsKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterOutput")
