...
var clusteroutputsResource = schema.GroupVersionResource{Group: "fluentd.fluent.io", Version: "v1alpha1", Resource: "clusteroutputs"}

var clusteroutputsKind = schema.GroupVersionKind{Group: "fluentd.fluent.io", Version: "v1alpha1", Kind: "ClusterOutput"}
...
func (c *FakeClusterOutputs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(clusteroutputsResource, c.ns, name), &v1alpha1.ClusterOutput{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterOutput), err
}
...
func (c *FakeClusterOutputs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterOutputList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(clusteroutputsResource, clusteroutputsKind, c.ns, opts), &v1alpha1.ClusterOutputList{})
	...
	list := &v1alpha1.ClusterOutputList{ListMeta: obj.(*v1alpha1.ClusterOutputList).ListMeta}
	for _, item := range obj.(*v1alpha1.ClusterOutputList).Items {
...
func (c *FakeClusterOutputs) Create(ctx context.Context, clusterOutput *v1alpha1.ClusterOutput, opts v1.CreateOptions) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(clusteroutputsResource, c.ns, clusterOutput), &v1alpha1.ClusterOutput{})
...
func (c *FakeClusterOutputs) Update(ctx context.Context, clusterOutput *v1alpha1.ClusterOutput, opts v1.UpdateOptions) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(clusteroutputsResource, c.ns, clusterOutput), &v1alpha1.ClusterOutput{})
...
func (c *FakeClusterOutputs) UpdateStatus(ctx context.Context, clusterOutput *v1alpha1.ClusterOutput, opts v1.UpdateOptions) (*v1alpha1.ClusterOutput, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(clusteroutputsResource, "status", c.ns, clusterOutput), &v1alpha1.ClusterOutput{})
...
func (c *FakeClusterOutputs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(clusteroutputsResource, c.ns, name), &v1alpha1.ClusterOutput{})
...
func (c *FakeClusterOutputs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.ClusterOutputList{})
	return err
}
...
func (c *FakeClusterOutputs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(clusteroutputsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ClusterOutput{})
