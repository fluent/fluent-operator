...
func (c *FakeClusterOutputs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clusteroutputsResource, name), &v1alpha1.ClusterOutput{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterOutputs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterOutputList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clusteroutputsResource, clusteroutputsKind, opts), &v1alpha1.ClusterOutputList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterOutputs) Create(ctx context.Context, clusterOutput *v1alpha1.ClusterOutput, opts v1.CreateOptions) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clusteroutputsResource, clusterOutput), &v1alpha1.ClusterOutput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterOutput), err
...
func (c *FakeClusterOutputs) Update(ctx context.Context, clusterOutput *v1alpha1.ClusterOutput, opts v1.UpdateOptions) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clusteroutputsResource, clusterOutput), &v1alpha1.ClusterOutput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterOutput), err
...
func (c *FakeClusterOutputs) UpdateStatus(ctx context.Context, clusterOutput *v1alpha1.ClusterOutput, opts v1.UpdateOptions) (*v1alpha1.ClusterOutput, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clusteroutputsResource, "status", clusterOutput), &v1alpha1.ClusterOutput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterOutput), err
...
func (c *FakeClusterOutputs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterOutput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clusteroutputsResource, name, pt, data, subresources...), &v1alpha1.ClusterOutput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterOutput), err
