...
func (c *FakeClusterInputs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ClusterInput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clusterinputsResource, name), &v1alpha1.ClusterInput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterInput), err
}
...
func (c *FakeClusterInputs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClusterInputList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clusterinputsResource, clusterinputsKind, opts), &v1alpha1.ClusterInputList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.ClusterInputList{ListMeta: obj.(*v1alpha1.ClusterInputList).ListMeta}
	for _, item := range obj.(*v1alpha1.ClusterInputList).Items {
...
func (c *FakeClusterInputs) Create(ctx context.Context, clusterInput *v1alpha1.ClusterInput, opts v1.CreateOptions) (result *v1alpha1.ClusterInput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clusterinputsResource, clusterInput), &v1alpha1.ClusterInput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterInput), err
...
func (c *FakeClusterInputs) Update(ctx context.Context, clusterInput *v1alpha1.ClusterInput, opts v1.UpdateOptions) (result *v1alpha1.ClusterInput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clusterinputsResource, clusterInput), &v1alpha1.ClusterInput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterInput), err
...
func (c *FakeClusterInputs) UpdateStatus(ctx context.Context, clusterInput *v1alpha1.ClusterInput, opts v1.UpdateOptions) (*v1alpha1.ClusterInput, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clusterinputsResource, "status", clusterInput), &v1alpha1.ClusterInput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterInput), err
...
func (c *FakeClusterInputs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(clusterinputsResource, name, opts), &v1alpha1.ClusterInput{})
	return err
}
...
func (c *FakeClusterInputs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.ClusterInputList{})
	return err
}
...
func (c *FakeClusterInputs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ClusterInput, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clusterinputsResource, name, pt, data, subresources...), &v1alpha1.ClusterInput{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterInput), err
