...
var clusteroutputsResource = v1alpha2.SchemeGroupVersion.WithResource("clusteroutputs")

var clusteroutputsKind = v1alpha2.SchemeGroupVersion.WithKind("ClusterOutput")
