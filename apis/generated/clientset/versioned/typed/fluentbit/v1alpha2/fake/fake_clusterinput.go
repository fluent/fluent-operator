...
var clusterinputsResource = v1alpha2.SchemeGroupVersion.WithResource("clusterinputs")

var clusterinputsKind = v1alpha2.SchemeGroupVersion.WithKind("ClusterInput")
