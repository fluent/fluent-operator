...
var clusterfiltersResource = v1alpha2.SchemeGroupVersion.WithResource("clusterfilters")

var clusterfiltersKind = v1alpha2.SchemeGroupVersion.WithKind("ClusterFilter")
