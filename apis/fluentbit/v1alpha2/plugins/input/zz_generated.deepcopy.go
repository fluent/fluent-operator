...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExecWasi) DeepCopyInto(out *ExecWasi) {
	*out = *in
	...
	if in.IntervalNSec != nil {
		in, out := &in.IntervalNSec, &out.IntervalNSec
		*out = new(int64)
		**out = **in
	}
	if in.Threaded != nil {
		in, out := &in.Threaded, &out.Threaded
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExecWasi.
func (in *ExecWasi) DeepCopy() *ExecWasi {
	if in == nil {
		return nil
	}
	out := new(ExecWasi)
...
func (in *KubernetesEvents) DeepCopyInto(out *KubernetesEvents) {
	*out = *in
	...
	if in.KubeRequestLimit != nil {
		in, out := &in.KubeRequestLimit, &out.KubeRequestLimit
		*out = new(int32)
		**out = **in
	}
	if in.TLSDebug != nil {
...
func (in *OpenTelemetry) DeepCopyInto(out *OpenTelemetry) {
	*out = *in
	...
	if in.TagFromURI != nil {
		in, out := &in.TagFromURI, &out.TagFromURI
		*out = new(bool)
		**out = **in
	}
}
...
func (in *Tail) DeepCopyInto(out *Tail) {
	*out = *in
	...
	if in.SkipEmptyLines != nil {
		in, out := &in.SkipEmptyLines, &out.SkipEmptyLines
		*out = new(bool)
		**out = **in
	}
}
...
func (in *UDP) DeepCopyInto(out *UDP) {
	*out = *in
	...
	if in.SourceAddressKey != nil {
		in, out := &in.SourceAddressKey, &out.SourceAddressKey
		*out = new(string)
		**out = **in
	}
	if in.Threaded != nil {
