...
func (in *ClusterFluentdConfigSpec) DeepCopyInto(out *ClusterFluentdConfigSpec) {
	*out = *in
	...
	if in.ClusterInputSelector != nil {
		in, out := &in.ClusterInputSelector, &out.ClusterInputSelector
		*out = new(v1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *FluentdSpec) DeepCopyInto(out *FluentdSpec) {
	*out = *in
	...
	if in.DefaultInputSelector != nil {
		in, out := &in.DefaultInputSelector, &out.DefaultInputSelector
		*out = new(v1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
