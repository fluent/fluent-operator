...
type FluentBitSpec struct {
	...
	// ClusterFluentBitConfigName object associated with this ClusterFluentBitConfig
	ClusterFluentBitConfigName string `json:"clusterFluentBitConfigName,omitempty"`
