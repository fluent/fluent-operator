...
CODE_GENERATOR = $(shell go env GOPATH)/pkg/mod/k8s.io/code-generator@v0.29.1
code-generator: go-deps ## Download code-generator locally if necessary
	$(call go-get-tool,$(CODE_GENERATOR),k8s.io/code-generator@v0.29.1)
...
go-deps: # download go dependencies
	go get k8s.io/code-generator@v0.29.1
	go mod download
