...
// Throttle clusterfilter allows you to set the average rate of messages per internal, based on leaky bucket and sliding window algorithm.
...
// Name is the name of the clusterfilter plugin.
func (*Throttle) Name() string {
	return "throttle"
}

// Params represents the config options for the clusterfilter plugin.
