...
// RewriteTag define a `rewrite_tag` clusterfilter, allows to re-emit a record under a new Tag.
...
type RewriteTag struct {
	...
	// When the clusterfilter emits a record under the new Tag, there is an internal emitter
