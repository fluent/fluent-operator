...
// The http clusteroutput plugin allows to flush your records into a HTTP endpoint.
...
type HTTP struct {
	...
	// Specify the name of the time key in the clusteroutput record.
	...
	// HTTP clusteroutput plugin supports TTL/SSL, for more details about the properties available
