...
// DataDog clusteroutput plugin allows you to ingest your logs into Datadog.
type DataDog struct {
	...
	// Date key name for clusteroutput.
	JSONDateKey string `json:"json_date_key,omitempty"`
	// If enabled, a tag is appended to clusteroutput. The key name is used tag_key property.
