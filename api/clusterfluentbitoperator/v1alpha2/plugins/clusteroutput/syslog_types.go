...
// Syslog clusteroutput plugin allows you to deliver messages to Syslog servers.
type Syslog struct {
	...
	// Syslog clusteroutput plugin supports TTL/SSL, for more details about the properties available
