...
// ClusterFluentBitConfigSpec defines the desired state of ClusterFluentBitConfig
type ClusterFluentBitConfigSpec struct {
	// Service defines the global behaviour of the Fluent Bit engine.
	Service *Service `json:"service,omitempty"`
	// Select clusterinput plugins
...
type Service struct {
	...
	// File to log diagnostic clusteroutput
...
// ClusterFluentBitConfigStatus defines the observed state of ClusterFluentBitConfig
type ClusterFluentBitConfigStatus struct {
	// INSERT ADDITIONAL STATUS FIELD - define observed state of cluster
	// Important: Run "make" to regenerate code after modifying this file
}

//+kubebuilder:object:root=true
//+kubebuilder:resource:shortName=cfbc
//+kubebuilder:resource:scope=Cluster

// ClusterFluentBitConfig is the Schema for the clusterfluentbitconfigs API
type ClusterFluentBitConfig struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ClusterFluentBitConfigSpec   `json:"spec,omitempty"`
	Status ClusterFluentBitConfigStatus `json:"status,omitempty"`
}
...
func (cfg ClusterFluentBitConfig) RenderLuaScript(cl plugins.ConfigMapLoader, filters ClusterFilterList) ([]Script, error) {
