...
type OutputInterface interface {
	Create(*v1alpha2.Output) (*v1alpha2.Output, error)
	Update(*v1alpha2.Output) (*v1alpha2.Output, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.Output, error)
	List(opts v1.ListOptions) (*v1alpha2.OutputList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Output, err error)
	OutputExpansion
}
...
func (c *outputs) Get(name string, options v1.GetOptions) (result *v1alpha2.Output, err error) {
...
func (c *outputs) List(opts v1.ListOptions) (result *v1alpha2.OutputList, err error) {
...
func (c *outputs) Create(output *v1alpha2.Output) (result *v1alpha2.Output, err error) {
	result = &v1alpha2.Output{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("outputs").
...
func (c *outputs) Update(output *v1alpha2.Output) (result *v1alpha2.Output, err error) {
	result = &v1alpha2.Output{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("outputs").
...
func (c *outputs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Output, err error) {
	result = &v1alpha2.Output{}
